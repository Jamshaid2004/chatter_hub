...
class AudioPlayerManager {
  ...
  _GroupMessageBubbleState? _currentlyPlaying;

  void play(_GroupMessageBubbleState player) {
  ...
  void stop(_GroupMessageBubbleState player) {
      ...
      children: [
        ...
        if (!widget.isMe) ...[
          CircleAvatar(
            ...
            backgroundImage: widget.message.imageUrl != null && 
            ...
            children: [
                ...
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: _getColorForName(widget.message.senderUserId ?? ''),
                    ),
                  ),
                ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: widget.isMe ? const Color(0xFFF8B8E3) : const Color(0xFFE76B9A),
